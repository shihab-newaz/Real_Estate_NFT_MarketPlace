...
export default function MyPropertiesPage() {
  const { address, accountData } = useWalletConnection();
  ...
  if (!address) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
        ...
        <p className="mb-4">Please connect your wallet using the button in the navbar to view your properties.</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-100">
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          ...
          <p><strong>Balance:</strong> {accountData.balance} ETH</p>
          <p><strong>Network:</strong> {accountData.network} (Chain ID: {accountData.chainId})</p>
        </div>
