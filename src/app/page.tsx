...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setFeaturedProperties([
      ...
      { id: 2, title: 'Beachfront Villa', price: 5, location: 'Miami', type: 'House', img:'/villa.jpg' },
      { id: 3, title: 'Downtown Loft', price: 1.8, location: 'Chicago', type: 'Apartment', img:'/loft.jpg' },
    ]);
    setMarketStats({
      totalListings: 156,
      totalValue: 45,
